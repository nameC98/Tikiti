        ...
        <div className="grid grid-cols-1 md:grid-cols-2  gap-8">
          ...
          <div className="space-y-4 h-[48rem] md:h-[43rem] md:overflow-auto">
            ...
            <div className="border rounded-lg shadow-sm p-4 bg-white">
              ...
              <p className="text-gray-600 xl:text-2xl text-[15px]">
              ...
              <button className="mt-4 w-full bg-green-600 xl:text-2xl text-[15px] text-white py-2 rounded-lg hover:bg-green-700 transition">
                Purchase Ticket
              </button>
            </div>
